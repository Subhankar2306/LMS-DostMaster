...
const HomeCourse = () => {
  ...
  const visibleCourses = coursesData.slice(0, 8); // Show only first 8 courses
                ...
                >
                  <div className={homeCoursesStyles.imageContainer}>
                    <img
                      src={course.image}
                      alt={course.name}
                      className={homeCoursesStyles.classImage}
                      loading="lazy"
                    />
                  </div>
          ...
          <div className={homeCoursesStyles.ctaContainer}>
            ...
            >
              <span className={homeCoursesStyles.ctaButtonContent}>
                <span className={homeCoursesStyles.ctaButtonText}>
                  Browse All Courses
                </span>
