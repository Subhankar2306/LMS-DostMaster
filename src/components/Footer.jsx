            ...
            <div className={footerStyles.brandTransform}>
              <div className={footerStyles.brandContainer}>
                ...
                <div className="relative font-serif flex items-center gap-3">
                  ...
                  <h3 className={footerStyles.brandTitle}>DostMaster</h3>
                </div>
              </div>

              <p className={footerStyles.brandDescription}>
                Transform your learning journey with interetive courses and
                cutting-edge educational technology designed for mordern
                learners.
              </p>
            </div>
          </div>
